...
if(NOT _exported_typesupport_targets STREQUAL "")
  ...
  foreach(_tuple ${_exported_typesupport_targets})
    ...
    set(_target "my_robot_interfaces::${_target}")
    if(NOT TARGET "${_target}")
      # the exported target must exist
      message(WARNING "Package 'my_robot_interfaces' exports the typesupport target '${_target}' which doesn't exist")
    else()
      list(APPEND my_robot_interfaces_TARGETS${_suffix} "${_target}")
    endif()
  endforeach()
endif()
