...
my_robot_interfaces__msg__Int64__create(void)
{
  ...
  my_robot_interfaces__msg__Int64 * msg = (my_robot_interfaces__msg__Int64 *)allocator.allocate(sizeof(my_robot_interfaces__msg__Int64), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_robot_interfaces__msg__Int64));
  bool success = my_robot_interfaces__msg__Int64__init(msg);
  if (!success) {
...
my_robot_interfaces__msg__Int64__destroy(my_robot_interfaces__msg__Int64 * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_robot_interfaces__msg__Int64__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_robot_interfaces__msg__Int64__Sequence__init(my_robot_interfaces__msg__Int64__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__msg__Int64 * data = NULL;

  if (size) {
    data = (my_robot_interfaces__msg__Int64 *)allocator.zero_allocate(size, sizeof(my_robot_interfaces__msg__Int64), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_robot_interfaces__msg__Int64__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_robot_interfaces__msg__Int64__fini(&data[i - 1]);
      }
...
my_robot_interfaces__msg__Int64__Sequence__fini(my_robot_interfaces__msg__Int64__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_robot_interfaces__msg__Int64__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_robot_interfaces__msg__Int64__Sequence * array = (my_robot_interfaces__msg__Int64__Sequence *)allocator.allocate(sizeof(my_robot_interfaces__msg__Int64__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_robot_interfaces__msg__Int64__Sequence__init(array, size);
  if (!success) {
...
my_robot_interfaces__msg__Int64__Sequence__destroy(my_robot_interfaces__msg__Int64__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_robot_interfaces__msg__Int64__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_robot_interfaces__msg__Int64__Sequence__are_equal(const my_robot_interfaces__msg__Int64__Sequence * lhs, const my_robot_interfaces__msg__Int64__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_robot_interfaces__msg__Int64__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_robot_interfaces__msg__Int64__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_robot_interfaces__msg__Int64);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_robot_interfaces__msg__Int64 * data =
      (my_robot_interfaces__msg__Int64 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_robot_interfaces__msg__Int64__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_robot_interfaces__msg__Int64__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_robot_interfaces__msg__Int64__copy(
