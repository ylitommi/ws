...
#include "my_robot_interfaces/msg/detail/int64__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::Int64;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::Int64 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::Int64 *>(
    untyped_ros_message);
...
static size_t _Int64__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Int64(full_bounded, is_plain, 0);
...
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_Int64__handle;
}
